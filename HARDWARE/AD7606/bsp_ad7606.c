...
#define OS0_1()		GPIOF->BSRRL = GPIO_Pin_9
#define OS0_0()		GPIOF->BSRRH = GPIO_Pin_9
#define OS1_1()		GPIOF->BSRRL = GPIO_Pin_10
#define OS1_0()		GPIOF->BSRRH = GPIO_Pin_10
#define OS2_1()		GPIOF->BSRRL = GPIO_Pin_11
#define OS2_0()		GPIOF->BSRRH = GPIO_Pin_11

/* 启动AD转换的GPIO : PH12  , PH12/TIM5_CH3/DCMI_D3 */
#define CONVST_1()	GPIOF->BSRRL = GPIO_Pin_6
#define CONVST_0()	GPIOF->BSRRH = GPIO_Pin_6

/* 设置输入量程的GPIO :  */
#define RANGE_1()	GPIOF->BSRRL = GPIO_Pin_14
#define RANGE_0()	GPIOF->BSRRH = GPIO_Pin_14

/* AD7606复位口线 : PI4  */
#define RESET_1()	GPIOF->BSRRL = GPIO_Pin_7
#define RESET_0()	GPIOF->BSRRH = GPIO_Pin_7
...
/*
	...
	-----------------PD5/FSMC_NWE		--- 写控制信号，AD7606 只有读，无写信号 -----------------不接
	PD8/FSMC_D13
	PD9/FSMC_D14
	PD10/FSMC_D15
	...
	-----------------PE4/FSMC_A20		--- 和主片选一起译码---------不接
	-----------------PE5/FSMC_A21		--- 和主片选一起译码---------不接
	PE7/FSMC_D4
	PE8/FSMC_D5
	PE9/FSMC_D6
	PE10/FSMC_D7
	...
	--------------PG12/FSMC_NE4-------CS		--- 主片选（TFT, OLED 和 AD7606）

	其他的控制IO:

	PH9/DCMI_D0/AD7606_OS0			---> AD7606_OS0		OS2:OS0 选择数字滤波参数 --------不接
	PH10/DCMI_D1/AD7606_OS1         ---> AD7606_OS1                       --------不接
	PH11/DCMI_D2/AD7606_OS2         ---> AD7606_OS2                       --------不接
	PH12/DCMI_D3/AD7606_CONVST      ---> AD7606_CONVST	启动ADC转换 (CONVSTA 和 CONVSTB 已经并联) ----------PF5%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	PH14/DCMI_D4/AD7606_RAGE        ---> AD7606_RAGE	输入模拟电压量程，正负5V或正负10V            ----------不接
	PI4/DCMI_D5/AD7606_RESET        ---> AD7606_RESET	复位                                       ----------PF4%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	PI6/DCMI_D6/AD7606_BUSY         ---> AD7606_BUSY	忙信号	(未使用)                             ------------不接

*/
static void AD7606_CtrlLinesConfig(void)//初始化各个引脚
{
...
//	GPIO_PinAFConfig(GPIOE, GPIO_PinSource5 , GPIO_AF_FSMC);
	...
	*/
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9 | GPIO_Pin_10 | GPIO_Pin_11 | GPIO_Pin_14;
